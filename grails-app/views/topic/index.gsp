        ...
        <div class="panel">
            ...
            <div class="row">
                ...
                <div class="large-11 small-9 columns">
                    <a href="#"><h5>${topic.title}</h5></a>

                    <div class="row">
                        <div class="large-8 small-12 columns">
                            <g:each var="tag" in="${topic.tags}">
                                <a href="#"><span class="label radius">${tag.name}</span></a>
                            </g:each>
                        </div>

                        <div class="large-4 small-12 columns">
                            <span class="secondary label">Asked ${topic.question.content.date} by <a href="#">Foo</a></span>
                        </div>
                    </div>
                </div>
            </div>
